...
1. **Innovation** [PIL-01]: Leverage AI and machine learning for predictive maintenance and failure prevention
2. **User Experience** [PIL-02]: Intuitive interfaces for all user types, from executives to field technicians
3. **Integration** [PIL-03]: Open API architecture enabling seamless ecosystem connectivity
4. **Reliability** [PIL-04]: 99.9% uptime with robust offline-first mobile capabilities
5. **Security** [PIL-05]: Enterprise-grade security with comprehensive audit trails and compliance
...
1. **Reduce Maintenance Costs by 35%** [OBJ-1.1]
...
2. **Increase Asset Uptime to 95%** [OBJ-1.2]
...
- **Fleet Visibility** [BR-ORG-01]: Real-time location and status tracking for all assets
- **Maintenance Optimization** [BR-ORG-02]: Automated scheduling to minimize downtime and costs
- **Compliance Management** [BR-ORG-03]: Regulatory compliance tracking and automated reporting
- **Mobile Operations** [BR-ORG-04]: Field technicians need offline-capable tools for accurate documentation
- **Decision Support** [BR-ORG-05]: Analytics and reporting for strategic fleet management decisions
- **Fuel System Integration** [BR-ORG-06]: Connect with existing fuel management backend
- **Scalability** [BR-ORG-07]: Support growth from 50 to 5000+ assets without performance degradation

### Business Constraints

- **Budget Limitations** [BR-CON-01]: Mid-market pricing with enterprise capabilities
- **Implementation Timeline** [BR-CON-02]: Phased rollout over 6-9 months
- **Change Management** [BR-CON-03]: Minimize disruption to existing workflows during transition
- **Data Security** [BR-CON-04]: GDPR, SOX, and industry-specific compliance requirements
- **User Adoption** [BR-CON-05]: Intuitive interfaces to reduce training requirements
- **Technology Stack** [BR-CON-06]: Must use Nuxt 4/Vue 3/Capacitor/PostgreSQL/Redis architecture

### Success Criteria

- **System Adoption** [BR-SUC-01]: 95% user adoption rate within 3 months post-deployment
- **ROI Achievement** [BR-SUC-02]: Positive ROI within 18 months through cost savings and efficiency gains
- **Performance Metrics** [BR-SUC-03]: Sub-second response times for 95% of queries
- **Data Quality** [BR-SUC-04]: 99% accuracy in asset and maintenance data
- **Mobile Usage** [BR-SUC-05]: 80% of field work orders completed via mobile app
- **Compliance Score** [BR-SUC-06]: 100% audit trail completeness for regulatory inspections
...
1. **Cross-Platform Native App** [ADV-01]: Single codebase via Capacitor for Android and iOS with full native device access
2. **Custom Forms Builder** [ADV-02]: Visual form designer with 16+ field types vs. static forms
3. **Predictive Analytics** [ADV-03]: AI-powered failure prediction vs. basic time-based scheduling
4. **PostgreSQL Document Management** [ADV-04]: Integrated blob storage vs. external document systems
5. **Full-Stack TypeScript** [ADV-05]: Unified codebase vs. multi-language architectures
6. **NFC/QR Asset Tagging** [ADV-06]: Native NFC and QR code support for instant asset identification
7. **Integrated Operator Workflows** [ADV-07]: NFC/QR tap-on/tap-off, pre-starts, and fuel capture in one app
8. **Bluetooth OBD Integration** [ADV-08]: Automatic vehicle diagnostics without separate telematics
...
| Code        | Metric                            | Current Baseline | Target (6 months) | Target (12 months) |
| ----------- | --------------------------------- | ---------------- | ----------------- | ------------------ |
| KPI-OP-01   | Asset Uptime                      | 85%              | 92%               | 95%                |
| KPI-OP-02   | Mean Time Between Failures (MTBF) | 120 hours        | 180 hours         | 240 hours          |
| KPI-OP-03   | Mean Time To Repair (MTTR)        | 4.5 hours        | 3.0 hours         | 2.0 hours          |
| KPI-OP-04   | First-Time Fix Rate               | 65%              | 80%               | 90%                |
| KPI-OP-05   | Work Order Completion On-Time     | 70%              | 85%               | 95%                |
| KPI-OP-06   | Parts Inventory Accuracy          | 75%              | 90%               | 98%                |

### Financial KPIs

| Code        | Metric                            | Current Baseline       | Target (6 months)      | Target (12 months)    |
| ----------- | --------------------------------- | ---------------------- | ---------------------- | --------------------- |
| KPI-FI-01   | Maintenance Cost per Asset/Month  | $450                   | $350                   | $300                  |
| KPI-FI-02   | Total Cost of Ownership Reduction | N/A                    | 25%                    | 35%                   |
| KPI-FI-03   | Emergency Repair Costs            | 25% of total           | 15% of total           | 10% of total          |
| KPI-FI-04   | Parts Carrying Costs              | 15% of inventory value | 10% of inventory value | 8% of inventory value |
| KPI-FI-05   | Labor Utilization Rate            | 65%                    | 75%                    | 85%                   |
| KPI-FI-06   | ROI                               | N/A                    | 150%                   | 200%                  |

### User Adoption KPIs

| Code        | Metric                   | Target (3 months) | Target (6 months) |
| ----------- | ------------------------ | ----------------- | ----------------- |
| KPI-AD-01   | User Adoption Rate       | 80%               | 95%               |
| KPI-AD-02   | Mobile App Usage         | 70%               | 90%               |
| KPI-AD-03   | Operator Log-On Rate     | 85%               | 98%               |
| KPI-AD-04   | Pre-Start Completion     | 80%               | 95%               |
| KPI-AD-05   | Daily Active Users (DAU) | 70%               | 85%               |
| KPI-AD-06   | User Satisfaction Score  | 4.0/5.0           | 4.5/5.0           |
| KPI-AD-07   | Support Ticket Volume    | <50/month         | <30/month         |
| KPI-AD-08   | Training Completion Rate | 90%               | 100%              |

### Compliance & Quality KPIs

| Code        | Metric                          | Target |
| ----------- | ------------------------------- | ------ |
| KPI-CQ-01   | Audit Trail Completeness        | 100%   |
| KPI-CQ-02   | Compliance Violations           | 0      |
| KPI-CQ-03   | Data Accuracy Rate              | 99%    |
| KPI-CQ-04   | Security Incidents              | 0      |
| KPI-CQ-05   | Scheduled Maintenance Adherence | 95%    |
| KPI-CQ-06   | Document Management Accuracy    | 99%    |

---

## User Personas

### 1. Fleet Manager (Decision Maker) [PER-01]
...
### 2. Maintenance Supervisor (Power User) [PER-02]
...
### 3. Field Technician (Mobile User) [PER-03]
...
### 4. Vehicle Operator (Mobile User) [PER-04]
...
### 5. System Administrator (Technical User) [PER-05]
...
- **Task-Part Requirements** [FEA-MNT-03]
...
- **Asset-Specific Task Configuration** [FEA-MNT-04]
...
- **Category Inheritance** [FEA-MNT-06]
...
- **Field Technician Access** [FEA-MNT-07]
...
- **Compatibility Management** [FEA-INV-07]
...
- **Field Technician View** [FEA-INV-08]
...
- **Work Order Execution** [FEA-PWA-14]
...
- **NFC/QR Tap-On/Tap-Off** [FEA-OPS-01]
...
- **Operator Assignment Tracking** [FEA-OPS-02]
...
- **Certification Verification** [FEA-OPS-03]
...
- **NFC/QR-Initiated Inspections** [FEA-OPS-04]
...
- **Walk-Around Verification** [FEA-OPS-05]
...
- **Inspection Checklists** [FEA-OPS-06]
...
- **Vehicle Diagnostics** [FEA-OPS-08]
...
- **Automatic Data Capture** [FEA-OPS-09]
...
- **Supported Protocols** [FEA-OPS-11]
...
- **Fuel Bowser Authentication** [FEA-OPS-12]
...
- **Refueling Data Capture** [FEA-OPS-13]
...
- **Fuel System Integration Options** [FEA-OPS-14]
...
- **Background Location Services** [FEA-OPS-16]
...
| Code        | Tab                    | Content                                                             | Badge                 |
| ----------- | ---------------------- | ------------------------------------------------------------------- | --------------------- |
| UI-AST-01   | **Overview** (default) | Core asset details, status, specs, custom form fields, location map | —                     |
| UI-AST-02   | **Work Orders**        | Work order history, open/completed/scheduled                        | Count of open         |
| UI-AST-03   | **Maintenance**        | Scheduled maintenance, service history, next due dates              | Count of overdue      |
| UI-AST-04   | **Parts**              | Compatible parts list, stock availability, usage history            | Count of compatible   |
| UI-AST-05   | **Inspections**        | Pre-start inspection history, defect trends, compliance rate        | Count of open defects |
| UI-AST-06   | **Fuel**               | Fuel transaction history, consumption analytics, cost per km        | —                     |
| UI-AST-07   | **OBD**                | DTC history, live data (if connected), odometer/hours log           | Count of active DTCs  |
| UI-AST-08   | **Documents**          | Attached documents, certificates, expiry tracking                   | Count of expiring     |
| UI-AST-09   | **Location**           | Location history, route playback, geofence events                   | —                     |
| UI-AST-10   | **Operators**          | Operator session history, assignments                               | —                     |
...
| Code        | Tab                   | Content                                                              | Badge            |
| ----------- | --------------------- | -------------------------------------------------------------------- | ---------------- |
| UI-WO-01    | **Details** (default) | Work order info, asset summary, assignment, status, priority, dates  | —                |
| UI-WO-02    | **Checklist**         | Task checklist items, pass/fail status, completion progress          | Incomplete count |
| UI-WO-03    | **Parts**             | Required parts, actual parts used, stock availability, substitutions | —                |
| UI-WO-04    | **Photos**            | Attached photos, before/after documentation                          | Photo count      |
| UI-WO-05    | **Time & Cost**       | Labor hours, parts cost, total cost breakdown                        | —                |
| UI-WO-06    | **History**           | Status changes, comments, audit trail                                | —                |
...
| Code        | Tab                  | Content                                                           |
| ----------- | -------------------- | ----------------------------------------------------------------- |
| UI-OPV-01   | **Status** (default) | Vehicle status, current operator, OBD connection, last inspection |
| UI-OPV-02   | **Pre-Start**        | Start inspection button, last inspection summary, open defects    |
| UI-OPV-03   | **Fuel**             | Record refueling button, recent transactions, consumption stats   |
| UI-OPV-04   | **Issues**           | Report issue button, open defects, pending work orders            |
...
| Code        | Tab                   | Content                                                      | Badge                |
| ----------- | --------------------- | ------------------------------------------------------------ | -------------------- |
| UI-ODP-01   | **Profile** (default) | Operator details, certifications, licence info, expiry dates | Expiring certs count |
| UI-ODP-02   | **Sessions**          | Log-on/log-off history, vehicles operated, hours/distance    | —                    |
| UI-ODP-03   | **Inspections**       | Pre-start inspections completed, compliance rate             | —                    |
| UI-ODP-04   | **Fuel**              | Fuel transactions recorded                                   | —                    |
| UI-ODP-05   | **Training**          | Training records, certifications earned                      | —                    |
...
| Code        | Tab                   | Content                                               | Badge       |
| ----------- | --------------------- | ----------------------------------------------------- | ----------- |
| UI-PDP-01   | **Details** (default) | Part info, SKU, pricing, stock levels, reorder status | —           |
| UI-PDP-02   | **Compatibility**     | Compatible assets and categories                      | Asset count |
| UI-PDP-03   | **Stock**             | Stock movements, locations, transaction history       | —           |
| UI-PDP-04   | **Usage**             | Work orders where part was used, consumption trends   | —           |
| UI-PDP-05   | **Suppliers**         | Supplier info, pricing tiers, lead times              | —           |
...
| Code        | Tab                   | Content                                                   |
| ----------- | --------------------- | --------------------------------------------------------- |
| UI-IDP-01   | **Summary** (default) | Pass/fail result, operator, vehicle, timestamp, signature |
| UI-IDP-02   | **Checklist**         | All checklist items with status, photos, comments         |
| UI-IDP-03   | **Checkpoints**       | Walk-around checkpoint scan times and sequence            |
| UI-IDP-04   | **Defects**           | Failed items, linked work orders, resolution status       |
...
| Code        | Tab                     | Content                                                |
| ----------- | ----------------------- | ------------------------------------------------------ |
| UI-RDP-01   | **Dashboard** (default) | KPI cards, charts, configurable widgets                |
| UI-RDP-02   | **Assets**              | Asset utilisation, status breakdown, cost analysis     |
| UI-RDP-03   | **Maintenance**         | Work order metrics, compliance, technician performance |
| UI-RDP-04   | **Fuel**                | Consumption trends, cost analysis, anomalies           |
| UI-RDP-05   | **Operators**           | Session summaries, inspection compliance               |

### List Page Patterns

All list pages follow consistent patterns:

| Code        | Element            | Behaviour                                                       |
| ----------- | ------------------ | --------------------------------------------------------------- |
| UI-LST-01   | **Search Bar**     | Global search across visible columns                            |
| UI-LST-02   | **Filters**        | Collapsible filter panel, saved filter presets                  |
| UI-LST-03   | **Column Sorting** | Click header to sort, shift-click for multi-sort                |
| UI-LST-04   | **Bulk Actions**   | Checkbox selection, action toolbar appears                      |
| UI-LST-05   | **Pagination**     | Configurable page size (25/50/100), cursor-based for large sets |
| UI-LST-06   | **Export**         | Export filtered results to CSV/Excel                            |

### Mobile Navigation Patterns

| Code        | Pattern                    | Usage                                                       |
| ----------- | -------------------------- | ----------------------------------------------------------- |
| UI-NAV-01   | **Bottom Navigation**      | Primary sections (Dashboard, Assets, Work Orders, More)     |
| UI-NAV-02   | **Tab Bar**                | Page-level tabs (converts from desktop tabs)                |
| UI-NAV-03   | **Segmented Control**      | 2-4 options within a tab                                    |
| UI-NAV-04   | **Accordion**              | 5+ sections that don't need simultaneous visibility         |
| UI-NAV-05   | **Pull to Refresh**        | All list views                                              |
| UI-NAV-06   | **Floating Action Button** | Primary action (e.g., "New Work Order", "Start Inspection") |

### Form Patterns

| Code        | Pattern            | Usage                                               |
| ----------- | ------------------ | --------------------------------------------------- |
| UI-FRM-01   | **Stepped Form**   | Complex multi-section forms (e.g., asset creation)  |
| UI-FRM-02   | **Inline Edit**    | Quick field updates on detail pages                 |
| UI-FRM-03   | **Modal Form**     | Simple create/edit (e.g., add comment, assign user) |
| UI-FRM-04   | **Full Page Form** | Complex creation with many fields                   |
| UI-FRM-05   | **Auto-Save**      | Draft saving for long forms, offline forms          |
...
- **Production Environment** [TR-HW-01]
...
- **Desktop Browsers** [TR-HW-04]
  - Chrome 120+, Firefox 120+, Safari 16+, Edge 120+
  - Minimum resolution: 1366x768
  - Recommended: 1920x1080 or higher

- **Mobile Devices (PWA)** [TR-HW-05]
  - iOS 14+ (Safari)
  - Android 10+ (Chrome)
...
#### Minimum Mobile Requirements [TR-HW-07]
...
#### Dedicated Fleet Tablets (Recommended for Vehicles) [TR-HW-08]
...
#### Bluetooth OBD-II Dongles [TR-HW-10]
...
#### Runtime & Meta-Framework [TR-SW-01]
...
#### Mobile Native Stack (Capacitor) [TR-SW-05]
...
- **Tooling**: `vue-tsc --noEmit` for Vue files and `tsc --noEmit` for TypeScript files.
- **Strictness**: Strict mode enabled; no implicit `any`, strict null checks, and no-unused-locals enforced.
- **CI/CD**: Type-check must pass before any build or deployment.

#### Build Verification [TR-TST-03]
- **Scope**: Production build process for Web and Mobile targets.
- **Requirement**: `nuxt build` and `nuxt generate` must complete without errors.
- **Capacitor**: `cap sync` and native platform builds (Android/iOS) must be verified.
...
- **Key Journeys**:
  ...
  - Asset lifecycle: Creation, search, and detail management.
  - Work order flow: Assignment, execution, and completion.
  - Mobile synchronization: Offline data entry and conflict resolution (HLC).
  - Operator logging: NFC/QR tap-on/tap-off and pre-start checklists.
- **Visual Regression**: Baseline screenshot comparison for primary UI modules.
...
#### 1. Full-Stack TypeScript [ARCH-01]
...
#### 2. Vue 3 Composition API [ARCH-02]
...
#### 4. Offline-First PWA + Capacitor Native [ARCH-04]
...
#### 5. Modular Architecture [ARCH-05]
